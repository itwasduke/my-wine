...
const APP_SHELL = [
  ...
  './index.html',
  './manifest.json',
  const SHELL_CACHE = 'cellar-shell-v85';
  ...
    './css/base.css?v=2.0.57',
    './css/cards.css?v=2.0.57',
    './css/modal.css?v=2.0.57',
    './css/gallery.css?v=2.0.57',
    './css/vertical.css?v=2.0.57',
    './css/style.css?v=2.0.57',
    './js/app.js?v=2.0.57',
    './js/state.js?v=2.0.57',
    './js/ui.js?v=2.0.57',
    './js/render.js?v=2.0.57',
    './js/events.js?v=2.0.57',
    './js/modal.js?v=2.0.57',
    './js/db.js?v=2.0.57',
    './js/auth.js?v=2.0.57',
    './js/ai.js?v=2.0.57',
    './js/firebase.js?v=2.0.57',
    './js/analytics.js?v=2.0.57',
    './js/changelog.js?v=2.0.57',
    './js/renderChangelog.js?v=2.0.57',
];
