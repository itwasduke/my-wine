...
const APP_SHELL = [
  ...
  './index.html',
  './manifest.json',
  const SHELL_CACHE = 'cellar-shell-v83';
  ...
    './css/base.css?v=2.0.55',
    './css/cards.css?v=2.0.55',
    './css/modal.css?v=2.0.55',
    './css/gallery.css?v=2.0.55',
    './css/vertical.css?v=2.0.55',
    './css/style.css?v=2.0.55',
    './js/app.js?v=2.0.55',
    './js/state.js?v=2.0.55',
    './js/ui.js?v=2.0.55',
    './js/render.js?v=2.0.55',
    './js/events.js?v=2.0.55',
    './js/modal.js?v=2.0.55',
    './js/db.js?v=2.0.55',
    './js/auth.js?v=2.0.55',
    './js/ai.js?v=2.0.55',
    './js/firebase.js?v=2.0.55',
    './js/analytics.js?v=2.0.55',
    './js/changelog.js?v=2.0.55',
    './js/renderChangelog.js?v=2.0.55',
];
