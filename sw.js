...
const APP_SHELL = [
  ...
  './index.html',
  './manifest.json',
  const SHELL_CACHE = 'cellar-shell-v82';
  ...
    './css/base.css?v=2.0.54',
    './css/cards.css?v=2.0.54',
    './css/modal.css?v=2.0.54',
    './css/gallery.css?v=2.0.54',
    './css/vertical.css?v=2.0.54',
    './css/style.css?v=2.0.54',
    './js/app.js?v=2.0.54',
    './js/state.js?v=2.0.54',
    './js/ui.js?v=2.0.54',
    './js/render.js?v=2.0.54',
    './js/events.js?v=2.0.54',
    './js/modal.js?v=2.0.54',
    './js/db.js?v=2.0.54',
    './js/auth.js?v=2.0.54',
    './js/ai.js?v=2.0.54',
    './js/firebase.js?v=2.0.54',
    './js/analytics.js?v=2.0.54',
    './js/changelog.js?v=2.0.54',
    './js/renderChangelog.js?v=2.0.54',
];
