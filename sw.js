...
const APP_SHELL = [
  ...
  './icon.svg',
  './wine.jpg',
  './css/base.css?v=2.0.53',
  './css/cards.css?v=2.0.53',
  './css/modal.css?v=2.0.53',
  './css/gallery.css?v=2.0.53',
  './css/vertical.css?v=2.0.53',
  './css/style.css?v=2.0.53',
  './js/app.js?v=2.0.53',
  './js/state.js?v=2.0.53',
  './js/ui.js?v=2.0.53',
  './js/render.js?v=2.0.53',
  './js/events.js?v=2.0.53',
  './js/modal.js?v=2.0.53',
  './js/db.js?v=2.0.53',
  './js/auth.js?v=2.0.53',
  './js/ai.js?v=2.0.53',
  './js/firebase.js?v=2.0.53',
  './js/analytics.js?v=2.0.53',
  './js/changelog.js?v=2.0.53',
  './js/renderChangelog.js?v=2.0.53',
];
