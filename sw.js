const SHELL_CACHE = 'cellar-shell-v63';
...
const APP_SHELL = [
  ...
  './icon.svg',
  './wine.jpg',
  './css/base.css?v=2.0.36',
  './css/cards.css?v=2.0.36',
  './css/modal.css?v=2.0.36',
  './css/gallery.css?v=2.0.36',
  './css/style.css?v=2.0.36',
  './js/app.js?v=2.0.36',
  './js/state.js?v=2.0.36',
  './js/ui.js?v=2.0.36',
  './js/render.js?v=2.0.36',
  './js/events.js?v=2.0.36',
  './js/modal.js?v=2.0.36',
  './js/db.js?v=2.0.36',
  './js/auth.js?v=2.0.36',
  './js/ai.js?v=2.0.36',
  './js/firebase.js?v=2.0.36',
  './js/analytics.js?v=2.0.36',
];
