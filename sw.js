const SHELL_CACHE = 'cellar-shell-v81';
...
const APP_SHELL = [
  ...
  './index.html',
  './manifest.json',
  const SHELL_CACHE = 'cellar-shell-v84';
  ...
    './css/base.css?v=2.0.56',
    './css/cards.css?v=2.0.56',
    './css/modal.css?v=2.0.56',
    './css/gallery.css?v=2.0.56',
    './css/vertical.css?v=2.0.56',
    './css/style.css?v=2.0.56',
    './js/app.js?v=2.0.56',
    './js/state.js?v=2.0.56',
    './js/ui.js?v=2.0.56',
    './js/render.js?v=2.0.56',
    './js/events.js?v=2.0.56',
    './js/modal.js?v=2.0.56',
    './js/db.js?v=2.0.56',
    './js/auth.js?v=2.0.56',
    './js/ai.js?v=2.0.56',
    './js/firebase.js?v=2.0.56',
    './js/analytics.js?v=2.0.56',
    './js/changelog.js?v=2.0.56',
    './js/renderChangelog.js?v=2.0.56',
];
